...
class GroupOppositeVoteViewHolder(
    ...
    private fun MaterialAlertDialogBuilder.setVoteCustomDialog(item: GroupVoteCertificationDetail) {
        ...
        val dialogView = LayoutInflater.from(fragment.context).inflate(R.layout.dialog_group_vote_change_to_agree, null)
        ...
        val buttonGroupVoteChangeToAgree = dialogView.findViewById<TextView>(R.id.buttonGroupVoteChangeToAgree)
        ...
        val dialog = this.setView(dialogView).create().apply {
            ...
            buttonGroupVoteChangeToAgree.setOnClickListener {
