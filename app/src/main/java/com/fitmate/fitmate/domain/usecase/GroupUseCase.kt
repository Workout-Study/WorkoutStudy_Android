...
class GroupUseCase @Inject constructor(private val groupRepository: GroupRepository) {
    ...
    suspend fun fitGroupTopTen(withMaxGroup: Boolean, pageNumber: Int, pageSize: Int): Flow<FitGroupFilter> = groupRepository.fitGroupAll(withMaxGroup, pageNumber, pageSize)
