...
class MakeFitGroupUseCase @Inject constructor(
    ...
    suspend fun postRegisterFitGroup(fitGroupInfo: RequestRegisterFitGroupBody): Response<RegisterFitGroupResponseDto> = makeFitGroupRepository.postRegisterFitGroup(fitGroupInfo.toRegisterFitGroupDto())
}